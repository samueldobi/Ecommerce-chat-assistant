...
async function setupDatabaseAndCollection(): Promise<void> {
  ...
  // Get reference to the Ecommerce_assitant database
  const db = client.db("Ecommerce_assitant")
  ...
  if (collections.length === 0) {
    ...
    console.log("Created 'items' collection in 'Ecommerce_assitant' database")
  } else {
    console.log("'items' collection already exists in 'Ecommerce_assitant' database")
  }
}
